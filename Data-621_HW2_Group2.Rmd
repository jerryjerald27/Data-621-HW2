...
We can answer this question both theoretically and practically. 
...
Number of true positives (TP) , false positives (FP) and false negatives (FN) are always non negative . 

Since TP <= TP + FP , range of precision will be 0 to 1 

Since TP <= TP + FN , range of sensitivity will also be between 0 and 1 
 
**Lower bound of F1** 

Since Precision >= 0 , Sensitivity >= 0 
...
Therefore the upper limit of F1 score is 1 
